...
const Storm = () => {
  return (
    <div className="w-full h-[100vh] bg-Storm bg-no-repeat bg-center bg-cover relative">
      <div className="hidden w-full gap-5 lg:flex flex-col justify-center items-center absolute top-[200px]">
        <h2 className="font-bold text-3xl text-white">Solar Roof</h2>
        <p className="text-white">
          Transform your roof and produce clean eneargy
        </p>
      </div>
      <div className=" w-full flex lg:hidden flex-col justify-center items-center absolute top-[150px]">
        <h2 className="font-bold text-2xl text-white">Storm</h2>
        <p className="text-white p-2 mb-1">
          Order Online for{" "}
