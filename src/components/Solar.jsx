...
const Solar = () => {
  return (
    <div className="w-full h-[100vh] bg-Solar bg-no-repeat bg-center bg-cover relative">
      <div className="hidden w-full gap-5 lg:flex flex-col justify-center items-center absolute top-[200px]">
        <h2 className="font-bold text-3xl text-black">Solar Panel</h2>
        <p className="text-black">Lower cost solar panel in America</p>
      </div>
      <div className=" w-full flex lg:hidden flex-col justify-center items-center absolute top-[150px]">
        <h2 className="font-bold text-2xl">Storm</h2>
